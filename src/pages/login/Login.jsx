...
<h1 className='text-3xl font-bold text-center mb-10 '>Login  to Doc House</h1>
<form className='space-y-3 my-3' action="">


<div className="form-control w-full ">
  <label className="label">
    <span className="text-xl font-bold">Username or Email Address</span>
  </label>
...
<button className=' bg-doctor-btn text-white mt-2 input  w-full '>Sign In</button>
</form>

<span className='flex justify-center'>Please register at First ?  <Link to="/sign-up">  SIGN UP</Link> </span>
</div>
