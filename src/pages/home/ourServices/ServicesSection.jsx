...
const ServicesSection = () => {
    ...
    const tabElements=[
         ...
         {_id:2,label:'Cosmetic Dentisty', content:[{img:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZaaLHnAO8DLvpSQEZka7Q9H5uDwNMHJtFByefubY&s', heading: '', description:'', _id: '652138re774'}]},
         {_id:3,label:'Cavity Protection', content:[{img:'Oral Surgery', heading: '', description:'',_id: '652138dr774'}]},
  ...
  return (
   ...
   {
tabElements.map(n=> <Tab key={n._id} ><button className="hover:bg-doctor-btn btn bg-transparent	border-0 ">{n.label}</button></Tab>)
     }
   </div>
    </TabList>
    {
tabElements.map(n=> <TabPanel key={n._id}> 
